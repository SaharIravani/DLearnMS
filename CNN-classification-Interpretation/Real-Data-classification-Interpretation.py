...
from keras.layers import Activation, AveragePooling2D, GlobalMaxPooling2D, GlobalAveragePooling2D
...
batch_size = 2
#address to mean intensities of groups
test_path = '/home/sahar/Documents/Real-Data-LCMS/Using-a-Spike-In-Experiment-to-Evaluate-Analysis-of-LC-MS-Data/costomize-images-2/spike-no/'

test_interpretation ='/home/sahar/Documents/Real-Data-LCMS/Using-a-Spike-In-Experiment-to-Evaluate-Analysis-of-LC-MS-Data/costomizeImages-2-scratch-train-interpretation/'
...
save_model_train_real_data =  'real-data-model.h5'
...
#ResNet50 Model
#########################
#In this version the first layer drop out is discarded
def get_model():
...
def Train_model():
    ...
    model.fit_generator(imageLoader(fileList,y,batch_size),steps_per_epoch=np.ceil( len(fileList)/batch_size ) , epochs=20 )
    #model.save(save_model_train_real_data)
...
def featureMap_Visualization():
    ...
    model = load_model(save_model_train_real_datal)
    model.summary()
    #addres to a sample
    image = io.imread('/home/sahar/innvestigate/LC-MassSpectrometry_Application/newDataset/Images1500by2500-NoiseReduction/results-20-22/mean_train_images/mean_trainImage_20pep.png')
